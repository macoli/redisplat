...
import (
	...
	"github.com/macoli/redisplat/repository/mysql"
	"github.com/macoli/redisplat/repository/redis"
	"github.com/macoli/redisplat/routes"
...
func main() {
	// 通过命令行参数获取配置文件路径信息
	var filename string
	flag.StringVar(&filename, "c", "./config.yaml", "指定配置文件路径")
	flag.Parse()
